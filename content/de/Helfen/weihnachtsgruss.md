{
    ...
    "author": "WvS",
    "description": "Christian sendet Ihnen einen Weihnachtgruß. Während wir hier die Festtage genießen, möchten wir Sie über eine ernste Rückmeldung von unserem Team in Kamerun informieren. Die Transport- und Lebensmittelpreise haben sich in den letzten Wochen deutlich erhöht. Das betrifft besonders unsere Kinder im Projekt: Eine warme Mahlzeit.",
...
<div class="flexpictures">
    ...
    <label for="expand-image1">
        <img class="img-flexpictures" src="/img/Helfen/Informationen/Weihnachtskarte_Vorderseite.png#imagemd" alt="Weihnachtskarte_front" />
    </label>
