{
    "date": "2026-01-01T08:11:48+01:00",
    "draft": false,
    "title": "Finanzen 2025",
    "author": "WvS",
    "description": "Hier finden Sie die archivierten Finanzdaten für 2025.",
    "image": "/img/Finanzen/2025/Finanzen2025Title.png"
}
## Erträge
...
<label for="expand-image1">
  <img class="img-centered" src="/img/Finanzen/2025/GesamtErtrag.png#imagemd" alt="Gesamtertrag 2025" />
</label>
<div class="img-caption">Gesamtertrag 2025</div>
<br>

## Ausgaben
<br>

#### Detaillierte Auflistung der Kosten des Vereins für das Jahr 2025
<div class="scrollable-table">
{{< csv-table >}}
{{< include-file csv="static/img/Finanzen/2025/KostenDetails.csv" >}}
{{< /csv-table >}}
</div>  

#### Detaillierte Auflistung der Ausgaben in Kamerun für das Jahr 2025
<div class="scrollable-table">
{{< csv-table >}}
{{< include-file csv="static/img/Finanzen/2025/AusgabenInKamerunDetails.csv" >}}
{{< /csv-table >}}
</div>  
